...
class HomeDoctorsScreen extends StatefulWidget {
  const HomeDoctorsScreen({Key? key}) : super(key: key);
            ...
            HorizontalList(itemCount: tittleList.length, itemBuilder: (_,index){
              return Container(
                ...
                decoration: BoxDecoration(
                    ...
                    color:isSelect==tittleList[index]? kMainColor:kSubTitleColor,
                  boxShadow:[BoxShadow(
                ...
                child: Text(
                  tittleList[index],
                  style: TextStyle(
                       color: isSelect==tittleList[index]? kSubTitleColor:kMainColor),
                ),
              ).onTap((){
                setState(() {
                  isSelect=tittleList[index];
                  isChangBg=true;
                });
